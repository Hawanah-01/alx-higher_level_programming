...
You can find the source code here: github.com/alx-tools/0x01.py/blob/master/0-positive_or_negative_py
...
You can find the source code here: github.com/alx-tools/0x01.py/blob/master/1-last_digit_py
The variable number will store a different value every time you will run this program
